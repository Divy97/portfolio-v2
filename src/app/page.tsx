      ...
      <div className="max-w-6xl mx-auto space-y-8 sm:space-y-12 mt-16 sm:mt-20 lg:mt-24">
          ...
          <Reveal>
            ...
            <div className="p-4 sm:p-6 lg:p-8 bg-card rounded-lg border">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div className="p-4 sm:p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                {/* Card 2: Fun Factor */}
                <div className="p-4 sm:p-6 bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg border border-yellow-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                ...
                {/* Card 3: Cat Love */}
                <div className="p-4 sm:p-6 bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg border border-pink-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
        ...
        <Reveal>
          ...
          <div className="p-4 sm:p-6 bg-card rounded-lg border">
            <div className="flex flex-wrap gap-2 sm:gap-4 mb-4">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`px-3 sm:px-4 py-2 rounded-full work-sans-600 text-sm sm:text-base transition-all duration-200 transition-transform hover:-translate-y-0.5 active:scale-[.98] ${
                    activeTab === tab.id
            ...
            <div key={activeTab} className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              {projectsData[activeTab].map((project: Project, index: number) => (
                <Reveal key={project.id} delay={index * 75}>
                  <div className="p-4 sm:p-6 bg-card rounded-lg border hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    <div className="flex items-start justify-between mb-3 sm:mb-4">
                      ...
                      <div className="flex gap-1 sm:gap-2">
                       {project.githubUrl && <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="p-1 sm:p-2 text-primary hover:text-secondary transition-colors transition-transform hover:-translate-y-0.5 active:scale-[.98]"
                        >
          ...
          <div className="space-y-4 sm:space-y-6">
            {/* Master's Degree */}
            <div className="p-4 sm:p-6 bg-card rounded-lg border hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="p-4 sm:p-6 lg:p-8 bg-card rounded-lg border">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex flex-wrap gap-1 sm:gap-2">
                  <span className="px-3 sm:px-4 py-1 sm:py-2 bg-primary text-primary-foreground rounded-lg text-xs sm:text-sm work-sans-600 shadow-sm hover:shadow-md transition-all duration-200 transition-transform hover:-translate-y-0.5 active:scale-[.98]">ReactJS</span>
                  <span className="px-3 sm:px-4 py-1 sm:py-2 bg-primary text-primary-foreground rounded-lg text-xs sm:text-sm work-sans-600 shadow-sm hover:shadow-md transition-all duration-200 transition-transform hover:-translate-y-0.5 active:scale-[.98]">NextJS</span>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex flex-wrap gap-1 sm:gap-2">
                  <span className="px-3 sm:px-4 py-1 sm:py-2 bg-secondary text-secondary-foreground rounded-lg text-xs sm:text-sm work-sans-600 shadow-sm hover:shadow-md transition-all duration-200 transition-transform hover:-translate-y-0.5 active:scale-[.98]">Tailwind CSS</span>
                  <span className="px-3 sm:px-4 py-1 sm:py-2 bg-secondary text-secondary-foreground rounded-lg text-xs sm:text-sm work-sans-600 shadow-sm hover:shadow-md transition-all duration-200 transition-transform hover:-translate-y-0.5 active:scale-[.98]">Bootstrap</span>
                  <span className="px-3 sm:px-4 py-1 sm:py-2 bg-secondary text-secondary-foreground rounded-lg text-xs sm:text-sm work-sans-600 shadow-sm hover:shadow-md transition-all duration-200 transition-transform hover:-translate-y-0.5 active:scale-[.98]">Material UI</span>
                  <span className="px-3 sm:px-4 py-1 sm:py-2 bg-secondary text-secondary-foreground rounded-lg text-xs sm:text-sm work-sans-600 shadow-sm hover:shadow-md transition-all duration-200 transition-transform hover:-translate-y-0.5 active:scale-[.98]">ShadCN</span>
                </div>
              </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex flex-wrap gap-1 sm:gap-2">
                  <span className="px-3 sm:px-4 py-1 sm:py-2 bg-primary text-primary-foreground rounded-lg text-xs sm:text-sm work-sans-600 shadow-sm hover:shadow-md transition-all duration-200 transition-transform hover:-translate-y-0.5 active:scale-[.98]">Express</span>
          ...
          <div className="p-4 sm:p-6 bg-card rounded-lg border">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a
                ...
                className="px-4 sm:px-6 py-2 sm:py-3 bg-primary text-primary-foreground rounded-lg work-sans-600 hover:opacity-90 transition-opacity text-center transition-transform hover:-translate-y-0.5 active:scale-[.98]"
              >
                Send Email
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
                className="px-4 sm:px-6 py-2 sm:py-3 bg-secondary text-secondary-foreground rounded-lg work-sans-600 hover:opacity-90 transition-opacity text-center transition-transform hover:-translate-y-0.5 active:scale-[.98]"
          >
                View GitHub
          </a>
            </div>
